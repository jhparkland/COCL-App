...
fig_pie.update_layout(
    margin=dict(l=80, r=0, t=50, b=40), 
    width=290,  # Change width to the desired width
    height=190,  # Change height to the desired height
    )
...
fig_pie2.update_layout(
    margin=dict(l=80, r=0, t=60, b=20), 
    width=290,  # Change width to the desired width
    height=190,  # Change height to the desired height
    )
...
fig_line.update_layout(
    ...
    xaxis_title='Time',
    yaxis_title='Power',
    width=400,  # Change width to the desired width
...
fig_stacked_bar.update_layout(
    ...
    legend=dict(
        orientation="h",  # Set the orienstation of the legend to 'h' (horizontal)
        yanchor="bottom",  # Anchor the legend to the bottom of the plot
        y=1.02,  # Move the legend slightly above the top of the plot (value > 1 moves it above)
        xanchor="right",  # Anchor the legend to the right side of the plot
        x=1  # Set the legend position to the right side
...
horiz_bar.update_layout(
    ...
    yaxis_title='Values',
    height=320,                     # Setting the height of the chart
    width=390,
    legend=dict(
        orientation="h",  # Set the orientation of the legend to 'h' (horizontal)
        yanchor="bottom",  # Anchor the legend to the bottom of the plot
...
app.layout = html.Div(children=[
    ...
    html.Div(
        children=[
            html.Div(
                children=[
                    html.Img(id='display-image', src=logo_path, style={'width': '40px', 'height': '40px', 'margin-left': '11%','margin-right': '5px'}),
                    "Carbon-Watch",
                ],
                style={"display": "flex", "align-items": "center", "text-align":"center", 'margin-left': '11%'}
            ),
        ],
        className="header"
    ),
        ...
        children=[
            ...
            html.Div(
                ...
                html.Div(
                    ...
                    style={"width": "90%","height": "30%","float":"left"},
                ),
            ],
            className="column1"
            ),
